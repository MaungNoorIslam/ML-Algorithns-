...
|  25   |         [Banking App](/7-bank-project/solution)[Algorithms Techniques](https://github.com/drmnislam/mnislam.github.io)           |                      Experimentation to determine the most suitable algorithm for a given problem.                     | Machine learning algorithms are a set of techniques and methodologies used to design and train models that can learn from data and make predictions or decisions without explicit programming.                                                              |                                [State Management](/7-bank-project/4-state-management/README.md)  [Algorithms Techniques](https://github.com/drmnislam/mnislam.github.io)                               |          Jr. Islam M. (Harry) Noor          |
