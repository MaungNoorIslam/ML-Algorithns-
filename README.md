...
|  18   |           [Space Game](/6-space-game/solution)           |                          Collision detection                           | Make elements collide and react to each other using keypresses and provide a cooldown function to ensure the performance of the game    |                              [Collision Detection](/6-space-game/4-collision-detection/README.md)                              |          Chris          |
...
|  25   |         [Banking App](/7-bank-project/solution)          |                      Experimentation and iterative refinement are often necessary to determine the most suitable algorithm for a given problem.                     | Machine learning algorithms are a set of techniques and methodologies used to design and train models that can learn from data and make predictions or decisions without explicit programming. AI is focused on enabling systems to learn and improve from experience automatically.                                                             |                                [State Management](/7-bank-project/4-state-management/README.md)  [Algorithms Techniques](https://github.com/drmnislam/mnislam.github.io)                               |          Jr. Islam M. (Harry) Noor          |
